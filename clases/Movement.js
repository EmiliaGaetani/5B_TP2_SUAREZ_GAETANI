...
clients[3].savingsBanks[0].debitCards[0].consumptions.push(new Movement(new Date(2025,7,1), "Zara", 19000))
clients[2].savingsBanks[0].debitCards[0].consumptions.push(new Movement(new Date(2025,6,21), "Dia", 35000))
clients[1].savingsBanks[0].creditCards[0].consumptions.push(new Movement(new Date(2025,4,25), "Adidas", 40000))
clients[3].savingsBanks[0].creditCards[0].consumptions.push(new Movement(new Date(2025,6,13), "Topper", 15000))
