...
clients[2].savingsBanks[1].debitCards[0].consumptions.push(new Movement(new Date(2025,6,21), "Dia", 35000))
clients[1].creditCards[0].consumptions.push(new Movement(new Date(2025,4,25), "Adidas", 40000))
clients[3].creditCards[0].consumptions.push(new Movement(new Date(2025,6,13), "Topper", 15000))